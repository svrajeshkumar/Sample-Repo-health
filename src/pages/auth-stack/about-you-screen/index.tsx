    ...
    <StyledMainBox>
      ...
      <Box sx={{ flex: 1, paddingRight: "40px" }}>
        <Grid spacing={1} sx={{ marginLeft: "-10px", width: "100%" }} container>
          ...
          <Grid item md={12}>
            <LabelTextField label="Last 4 Digits of SSN" placeholder="" />
          </Grid>
          <Grid item md={12}>
            <LabelTextField label="Add allergies" placeholder="" />
          </Grid>
          <Grid item md={12}>
            <LabelTextField label="Add Health conditions" placeholder="" />
          </Grid>
